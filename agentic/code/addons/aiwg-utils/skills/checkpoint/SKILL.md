...
- @src/cli/handlers/subcommands.ts — Checkpoint command handler
- @docs/cli-reference.md — CLI reference
- @agentic/code/addons/aiwg-utils/skills/snapshot/SKILL.md — Full workflow snapshots (compare to checkpoints)
