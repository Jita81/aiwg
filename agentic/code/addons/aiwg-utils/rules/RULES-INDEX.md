...
**Full rule**: @agentic/code/addons/aiwg-utils/rules/instruction-comprehension.md
...
**Full rule**: @agentic/code/addons/aiwg-utils/rules/research-before-decision.md
...
**Full rule**: @agentic/code/addons/aiwg-utils/rules/context-budget.md
...
**Full rule**: @agentic/code/addons/aiwg-utils/rules/agent-deployment.md
...
*Full rule files: @agentic/code/addons/aiwg-utils/rules/*
