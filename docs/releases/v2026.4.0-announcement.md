...
`agentic/code/addons/agentic-installer/` ships the `setup.aiwg.io/v1` SetupManifest language — a Kubernetes-style YAML RFC for cross-platform, script-first software installation. (#663–#667)
