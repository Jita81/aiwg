...
const PROVIDER_EXPECTATIONS: Record<string, ProviderExpectation> = {
  ...
  cursor: {
    name: 'cursor',
    requiredDirs: ['.cursor/agents', '.cursor/skills', '.cursor/commands', '.cursor/rules'],
    rootFiles: [],
  ...
  factory: {
    name: 'factory',
    requiredDirs: ['.factory/droids', '.factory/skills', '.factory/commands', '.factory/rules'],
    rootFiles: [],
  ...
  codex: {
    ...
    skillDir: '.codex/skills',  // Project-local mirror; actual skills also at ~/.codex/skills/ and .agents/skills/
    ruleDir: '.codex/rules',
    aggregatedAgents: false,
    usesHomePaths: true,
    agentFileExt: '.md',
  ...
  opencode: {
    name: 'opencode',
    requiredDirs: ['.opencode/skill', '.opencode/rule'],
    rootFiles: [],
  ...
  copilot: {
    name: 'copilot',
    requiredDirs: ['.github/agents', '.github/skills', '.github/instructions'],
    rootFiles: [],
  ...
  windsurf: {
    name: 'windsurf',
    requiredDirs: ['.windsurf/skills', '.windsurf/rules'],
    rootFiles: ['AGENTS.md'],
